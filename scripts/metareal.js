...
function processInformationReport(result){
    ...
    //display more information from the symbol_resolution_report
    ...
    //change the Symbol from the input box, click Metadata Request button
    // and check the results from the console
...
//this function run when the RequestRealTime button clicked, it will send
...
function processRealTimeMarketData(result){
    ...
    $("#runTicker").get(0).disabled = false;
}
